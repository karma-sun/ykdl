...
![PyPI](https://img.shields.io/pypi/v/ykdl.svg)

A video downloader focused on China mainland video sites.

* Origin website: [https://github.com/zhangn1985/ykdl](https://github.com/zhangn1985/ykdl)
* Later migrated to: [https://github.com/SeaHOH/ykdl](https://github.com/SeaHOH/ykdl)
* Now migrated to: [https://github.com/LifeActor/ykdl](https://github.com/LifeActor/ykdl)

This project is a fork of [you-get](https://github.com/soimort/you-get) with the following changes:

* Structured source code.
* Focus on China mainland video sites.
* Dropped supports of Python 3.4 and below (see [#487](https://github.com/SeaHOH/ykdl/issues/487)).
...
* [FFmpeg](https://ffmpeg.org/), for merging media files.
* [mpv](https://mpv.io/), default media player (optimal compatibility).
...
* **Windows**:
  Folders of `ffmpeg.exe`, `mpv.exe`, `python.exe`, and
  `"<PYTHONHOME>\Scripts"`
...
[https://github.com/SeaHOH/ykdl/wiki/sites-status](https://github.com/SeaHOH/ykdl/wiki/sites-status)
